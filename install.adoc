...
is a compressed archive.  When you uncompress the download, it will create a folder starting with "openshift-origin-client-tools-v1.5.1-7". I would suggest moving the contents of that folder (including the oc executable) to the relevant directory below:
...
WARNING: Openshift Client versions need to match the Openshift Server you're running. In this lab we are using Openshift version 3.6
