...
is a compressed archive. When you uncompress the download, it will create a folder starting with "openshift-origin-client-tools-v1.5.1-7". I would suggest moving this file to the relevant directory below (so that the oc executable is in that directory):
