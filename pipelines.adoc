...
Edit the deployment config for the nationalparks application, to uncheck the "Automatically start a new deployment when the image changes" option (at https://{{ROUTER_ADDRESS}}/console/project/{{EXPLORE_PROJECT_NAME}}/edit/dc/nationalparks).
