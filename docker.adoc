...
[source]
----
openshiftroadshow/{{PARKSMAP_IMAGENAME}}:{{PARKSMAP_VERSION}}
----
...
Hit the blue "Deploy" button at the bottom of the screen and then click the
...
Docker-formatted image deployed (and running) on OpenShift. This should work with any
...
page. If you click in the *Pod* circle, in the project Overview, you will
