...
Find your name in the list and use the userid against your name, userids are between user01 and user{{ NUM_USERS }}. This will be your user account for the duration of these exercises. For example:

----
userxx Luke Skywalker
----

If your name is not already on the list please let one of the organisers know.
{% endif %}
