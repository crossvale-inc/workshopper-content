...
You can also see that both *Pods* are running using the web console (you may need to click the Overview icon on the top left to get back to the overview page):
