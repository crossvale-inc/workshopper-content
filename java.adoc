...
WARNING! This URL is different from the one mentioned previously.
...
process to grab that specific tag in the code repository. Please also check that the Context Dir field contains "/".
