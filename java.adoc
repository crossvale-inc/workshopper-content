...
Please be especially careful to replace the "XX" in the git URL with your unique user number as it will be quite tricky to remedy if you get it wrong.
====
...
concept of *Branches/Tags*. Click on *Show advanced options for source, routes, builds, and deployments*. In the *Git Reference* field enter "*{{NATIONALPARKS_VERSION}}*". This will cause the S2I
