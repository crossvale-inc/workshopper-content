...
click the *"Add to Project"* button, then *"Browse Catalog"*. You will see a list of categories of runtimes, and other types of components that you can deploy and run on OpenShift.
...
and for the Git repository URL, enter (again, remember to replace the "XX" and note this is a different URL to the one above!):
...
concept of *Branches/Tags*. 

Click *Show advanced options for source, routes, builds, and deployments* (If you accidentally click the "Try It" link, you will need to update the Git Repository URL again). 

In the *Git Reference* field enter "*{{NATIONALPARKS_VERSION}}*". This will cause the S2I
