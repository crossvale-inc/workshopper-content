...
Click on the *{{EXPLORE_PROJECT_NAME}}{{USER_SUFFIX}}* project (top right). When you click on the
...
Click the link that says *Open metrics URL*, and accept the certificate. You will need to refresh the OpenShift console window to actually get rid of the error message after accepting the certificate.
